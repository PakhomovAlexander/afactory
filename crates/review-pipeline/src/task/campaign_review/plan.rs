...
pub struct CampaignReviewPlanCompiler {
...
impl CampaignReviewPlanCompiler {
    ...
    pub fn round(&self) -> &CapturedCampaignReviewRound {
        &self.round
    }
    ...
    fn compile_graph(
        ...
        review_config::task::campaign_review::owned::install_owned_review_children(
            &captured.loaded,
            compiled,
        )?;
    ...
    fn contract(
        &self,
        compiled: &CampaignReviewCompilation,
    ) -> (
    ...
    fn compile_inner(
        ...
        graph.install_provider_admission(&bindings, &self.settings().provider_admission)?;
