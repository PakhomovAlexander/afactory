//! Captured Campaign Review inputs and domain operations for the common Task host. Nothing in
...
use review_config::task::campaign_review::{
    CampaignReviewCompilation, ReviewCompileContext, ReviewNodeMapping, ReviewWorker,
...
pub struct CapturedCampaignReviewRound {
...
pub struct CapturedReviewCompilation {
    ...
    pub compilation: CampaignReviewCompilation,
}
...
impl CapturedCampaignReviewRound {
    pub fn load(
        cas: &Cas,
        store: &EventStore,
        campaign: &str,
    ...
    pub fn binding(&self) -> CampaignReviewRoundV1 {
    ...
    pub fn compile_existing(
        ...
        let mut compilation =
            review_config::task::campaign_review::compile_campaign_review(&loaded, context)?;
        compilation.graph.token_scopes =
            review_config::task::campaign_review::resources::review_token_scopes(
                &loaded,
                &compilation,
    ...
    fn validate_inputs(
        ...
        for (name, ty) in [
            ...
            ("round", CAMPAIGN_REVIEW_ROUND_V1),
        ] {
