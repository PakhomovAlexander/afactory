...
- [ ] P07–P09: local Worker replacement and embedded Review are implemented; Git catalog sync,
  Task-kind packages, bounded repair and current-Snapshot fix verification remain.
