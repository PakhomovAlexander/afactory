...
**Status:** accepted, 2026-09-12; the Task-runtime cutover it was an execution checkpoint of is
complete. Superseded in part by [ADR-0113](0113-ga-reads-only-what-ga-writes.md): the legacy
Kernel that composed this state and kept its own execution and replay owner.
