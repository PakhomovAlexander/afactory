...
ADR-0100 narrowly supersedes the exhaustive command list below for machine-local
`af provider setup`; repository-authority and execution commands remain pinned.
