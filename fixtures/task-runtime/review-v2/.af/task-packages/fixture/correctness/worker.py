...
assert a['reviewer']=="correctness"
assert all(f['source']=="correctness" for f in a['findings'])
assert len(a['findings']) == (1 if s['round']==2 and "correctness"=='correctness' else 0)
...
if s['round']==1 and "correctness"=='correctness':
